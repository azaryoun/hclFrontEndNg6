...
export class PageComponentBase<TModel>  {
  ...
  public showEntityDialog: boolean = false; //a flag to show/hide dialogEntityWeb component
  ...
  public showDeleteConfirm: boolean = false; //a flag to show/hide DialogConfirm component
